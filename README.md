...
| **Database Management Tools**  | [PhpMyAdmin](https://laradock.io/docs/services/phpmyadmin), [Adminer](https://laradock.io/docs/services/adminer), [PgAdmin](https://laradock.io/docs/services/pgadmin), [MongoDB Web UI](https://laradock.io/docs/services/mongo-webui), [Mongo Express](https://laradock.io/docs/services/mongo-express), [Tarantool Admin](https://laradock.io/docs/services/tarantool-admin), [pgbackups (PostgreSQL)](https://laradock.io/docs/services/pgbackups) |
