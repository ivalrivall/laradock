...
| **Database Management Tools**  | [PhpMyAdmin](/docs/services/phpmyadmin), [Adminer](/docs/services/adminer), [PgAdmin](/docs/services/pgadmin), [MongoDB Web UI](/docs/services/mongo-webui), [Mongo Express](/docs/services/mongo-express), [Tarantool Admin](/docs/services/tarantool-admin), [pgbackups (PostgreSQL)](/docs/services/pgbackups) |
